...
async function run() {
    try {
        ...
        const userM2SettingsXmlPath = tl.getTaskVariable('userM2SettingsXmlPath');
        const backupUserM2SettingsFilePath = tl.getTaskVariable('backupUserM2SettingsFilePath');
